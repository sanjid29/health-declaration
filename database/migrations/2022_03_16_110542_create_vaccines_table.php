...
class CreateVaccinesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->module_table = 'vaccines';
        $module->route_path = 'vaccines';
        $module->route_name = 'vaccines';
        $module->class_directory = 'app/Projects/HealthDeclaration/Modules/Vaccines';
        $module->namespace = '\App\Projects\HealthDeclaration\Modules\Vaccines';
        $module->model = '\App\Projects\HealthDeclaration\Modules\Vaccines\Vaccine';
        $module->policy = '\App\Projects\HealthDeclaration\Modules\Vaccines\VaccinePolicy';
        $module->processor = '\App\Projects\HealthDeclaration\Modules\Vaccines\VaccineProcessor';
        $module->controller = '\App\Projects\HealthDeclaration\Modules\Vaccines\VaccineController';
        $module->view_directory = 'projects.health-declaration.modules.vaccines';
