...
@section('content')
    <div class="card-body">
        ...
        @if($declaration->decision=="You are Allowed to Travel")
            <h4 style="color:green !important;padding: 5px;">You are Allowed to Travel</h4>
            <h4 style="color:green !important;padding: 5px;">You can download/print the pdf by clicking below</h4>
            <div align="left">
        ...
        @else
            <h4 style="color:red !important;padding: 5px;">You are Not Allowed to Travel</h4>
        @endif
    </div>
@endsection
