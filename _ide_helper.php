...
')
     ...
     */ 
        ...
        {
                        /** @var \Collective\Remote\RemoteManager $instance */
                        return $instance->into($name);
        }
                    /**
         * Get a remote connection instance.
         *
        ...
        {
                        /** @var \Collective\Remote\RemoteManager $instance */
                        return $instance->multiple($names);
        }
                    /**
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mainframe\Macros\QueryBuilderMacros::whereSubstring()
         * @param mixed $attribute
         * @param mixed $needles
         * @static 
         */ 
        public static function whereSubstring($attribute, $needles)
        {
                        return \Illuminate\Database\Query\Builder::whereSubstring($attribute, $needles);
        }
