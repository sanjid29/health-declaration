...
use \App\Projects\HealthDeclaration\Features\Modular\BaseModule\BaseModuleObserver;
use App\Division;

class DivisionObserver extends BaseModuleObserver
{
    // Note: Pull in necessary traits from relevant mainframe class

    // /**
    //  * @param  App\Division  $element
    //  * @return void|bool
    //  */
